#adapted from github.com/LingDong-/linedraw
...
def makesvg(lines,w,h):
    ...
    out = '<svg xmlns="http://www.w3.org/2000/svg" width="' + str(w)  + 'px" height="' + str(h) + 'px" version="1.1">'
    for l in lines:
